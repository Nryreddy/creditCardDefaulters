...
class Model_Finder:
    ...
    def get_best_params_for_naive_bayes(self,train_x,train_y):
        ...
        try:
            ...
            self.logger_object.log(self.file_object,
                                   'Exception occurred in get_best_params_for_naive_bayes method of the Model_Finder class. Exception message:  ' + str(e))
            self.logger_object.log(self.file_object,
    ...
    def get_best_params_for_xgboost(self,train_x,train_y):
        ...
        try:
            self.param_grid_xgboost = {"n_estimators": [50,100, 130],
