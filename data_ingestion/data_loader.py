...
class Data_Getter:
    """
    The Data_Getter class will be used for obtaining the data from the source for training.
    ...
    def get_data(self):
        ...
        Description: This method used to read the data from source.
        Output: A pandas DataFrame.
        """
        self.logger_object.log(self.file_object,'Entered the get_data method of the Data_Getter class')
        try:
            self.data= pd.read_csv(self.training_file) # read data file
